jQuery(document).ready(function($){
	if(!($('.cd-section').filter('.visible').is('#section1'))) {
    ...
    $('#side-menu').on('click', 'a:not(#blog)', function(event){
        event.preventDefault();
        smoothScroll($(this.hash));
    });
    ...
    function smoothScroll(target) {
        ...
        while(!reached) {
        	...
        	current = current.next('.cd-section');
	...
	//$('#section3 li:nth-child(3n)').css('margin-right', pad);
	/*$('#section3 li').hover(function() {
		$(this).find
	});*/
	
	//open team-member bio
	$('#section3').find('ul a').on('click', function(event){
		event.preventDefault();
		...
		if( is_firefox ) {
			$('#section3').addClass('slide-out').one('webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend', function(){
				$('body').addClass('overflow-hidden');
			});
		} else {
			$('#section3').addClass('slide-out');
			$('body').addClass('overflow-hidden');
		}
	...
	$(document).on('click', '.cd-overlay, .cd-member-bio-close', function(event){
		...
		if( is_firefox ) {
			$('#section3').removeClass('slide-out').one('webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend', function(){
				$('body').removeClass('overflow-hidden');
			});
		} else {
			$('#section3').removeClass('slide-out');
			$('body').removeClass('overflow-hidden');
		}
	});
	//end of bio------------------------------------------------------------------------
